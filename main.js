const translations = {
  en: {
    ...
    "project-euskorea-desc": "The bridge between Basque and Korean cultures. K-Pop, food, and beauty.",
    "project-togles-desc": "No-code development agency building digital solutions with speed and precision.",
    "project-bloom-desc": "Marketing and automation agency specializing in digital growth for SMEs.",
    "project-niem-desc": "Global event organization project collaborating with charities for social impact.",
    "members-title": "The Team",
    "contact-title": "Get in Touch",
    "contact-desc": "Interested in collaborating or have a question? Drop us an email.",
  ...
  es: {
    ...
    "project-euskorea-desc": "El puente entre las culturas vasca y coreana. K-Pop, gastronomía y estética.",
    "project-togles-desc": "Agencia de desarrollo no-code creando soluciones digitales con rapidez y precisión.",
    "project-bloom-desc": "Agencia de marketing y automatización especializada en crecimiento digital para PYMEs.",
    "project-niem-desc": "Proyecto global de organización de eventos colaborando con ONGs para impacto social.",
    "members-title": "El Equipo",
    "contact-title": "Contacto",
    "contact-desc": "¿Interesado en colaborar o tienes alguna pregunta? Envíanos un email.",
  ...
  de: {
    ...
    "projects-title": "Aktive Projekte",
    "project-euskorea-desc": "Die Brücke zwischen baskischer und koreanischer Kultur. K-Pop, Essen und Schönheit.",
    "project-togles-desc": "No-Code-Entwicklungsagentur, die digitale Lösungen mit Schnelligkeit und Präzision erstellt.",
    "project-bloom-desc": "Marketing- und Automatisierungsagentur, spezialisiert auf digitales Wachstum für KMU.",
    "project-niem-desc": "Globales Event-Organisationsprojekt, das mit Wohltätigkeitsorganisationen für soziale Wirkung zusammenarbeitet.",
    "members-title": "Das Team",
    "contact-title": "Kontakt",
    "contact-desc": "Interessiert an einer Zusammenarbeit oder haben Sie eine Frage? Senden Sie uns eine E-Mail.",
  ...
  ko: {
    ...
    "projects-title": "활성 프로젝트",
    "project-euskorea-desc": "바스크와 한국 문화 사이의 가교. K-Pop, 음식, 뷰티.",
    "project-togles-desc": "속도와 정밀함으로 디지털 솔루션을 구축하는 노코드 개발 에이전시.",
    "project-bloom-desc": "중소기업의 디지털 성장을 전문으로 하는 마케팅 및 자동화 에이전시.",
    "project-niem-desc": "사회적 임팩트를 위해 자선 단체와 협력하는 글로벌 이벤트 기획 프로젝트.",
    "members-title": "우리 팀",
    "contact-title": "문의하기",
    "contact-desc": "협업에 관심이 있거나 질문이 있으신가요? 이메일을 보내주세요.",
